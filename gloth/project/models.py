...
class Treatment(db.Model):
    ...
    icd_10 = db.Column(db.String(50), primary_key=True)
...
class Medication(db.model):
    ...
    molecule_id = db.Column(db.Integer, nullable=False, default=0)
...
class Molecules(db.model):
    ...
    id = db.Column(db.Integer, primary_key=True, nullable=False)
    name = db.Column(db.String(100), unique=True)
    rcp = db.Column(db.String(100), unique=True)
    rcp_sum = db.Column(db.String(), nullable=True)

    def __init__(self, id, name, rcp, rcp_sum):
        self.id = id
        self.name = name
        self.rcp = rcp
