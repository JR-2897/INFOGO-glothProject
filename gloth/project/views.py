...
def medic():
    ...
    # Doit permettre d'envoyer l'id de la pathologie pour récupérer le(s) cis de celle-ci
    #list = treatment(patho_id)
    return render_template("medic.html", name="Ynov", pathology=patho_id, user=user_id) #, listTreatement=list)